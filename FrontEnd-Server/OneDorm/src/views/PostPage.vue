...
<template>
    <main>
        ...
        <template v-else>
            ...
            <template v-else>
                <PostContainer :PostID="PostID" :postFull="true" :CreatorName="Cname" :postTitle="postTitle" :AnswerCount="AnsCount" :Hashtags="Hashtags" :PostContent="postcont" :Score="score"/>
