...
import {CreateBlog, EditBlog} from '../Helpers/APIs/BlogAPIs'
...
onBeforeMount(async ()=>{
    ...
    BlogData = await GetBlog(props.BlogID);
    ...
    quill.root.innerHTML = blogcont.value;
})
const wtv = ref('');
...
<template>
    <div class="card bg-Yellow w-10/12 rounded-none border border-2 border-black relative shadow-BoxDropBlack mx-auto my-10 click:shadow-none transition-all duration-150 ease-in-out">
        ...
        <div class="card-body items-start text-left ml-48">
            ...
            <h2 class="text-4xl font-bold font-Inter leading-10	text-black">Edit your blog title:</h2>
        ...
        <div class="card-body items-start text-left self-center w-10/12 px-0">
            <h2 class="text-4xl font-bold font-Inter leading-10	text-black ">Edit your blog content:</h2>
        ...
        <div class="form-control w-10/12 mb-10 self-center">
            <div class="self-center">
                ...
                <button class="btn mx-2 bg-main3 border-2 border-black tracking-wider text-xl btn-lg hover:shadow-BoxBlackSm" @click="PublishHandler">Edit!</button>
            </div>
        </div>
    </div>
</template>
